...
describe('Specimen Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'specimen', component: SpecimenComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specimen?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
