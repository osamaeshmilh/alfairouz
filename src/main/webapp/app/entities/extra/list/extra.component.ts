...
export class ExtraComponent implements OnInit {
  ...
  trackId(_index: number, item: IExtra): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IExtra[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
