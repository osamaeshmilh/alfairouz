...
describe('Biopsy Management Component', () => {
  let comp: BiopsyComponent;
  let fixture: ComponentFixture<BiopsyComponent>;
  let service: BiopsyService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'biopsy', component: BiopsyComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BiopsyComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.biopsies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
