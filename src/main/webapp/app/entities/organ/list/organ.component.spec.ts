...
describe('Organ Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'organ', component: OrganComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OrganComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.organs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
